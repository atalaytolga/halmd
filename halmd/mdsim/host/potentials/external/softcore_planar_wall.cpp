...
HALMD_LUA_API int luaopen_libhalmd_mdsim_host_potentials_external_softcore_planar_wall(lua_State* L)
{
#ifndef USE_HOST_SINGLE_PRECISION
    softcore_planar_wall<3, double>::luaopen(L);
    softcore_planar_wall<2, double>::luaopen(L);
    forces::external<3, double, softcore_planar_wall<3, double>>::luaopen(L);
    forces::external<2, double, softcore_planar_wall<2, double>>::luaopen(L);
#else
...
#ifndef USE_HOST_SINGLE_PRECISION
template class softcore_planar_wall<3, double>;
template class softcore_planar_wall<2, double>;
#else
...
#ifndef USE_HOST_SINGLE_PRECISION
template class external<3, double, softcore_planar_wall<3, double>>;
template class external<2, double, softcore_planar_wall<2, double>>;
#else
